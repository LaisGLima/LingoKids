...
const CoresEScreen = ({ navigation }) => {
  const { language, audios } = useLanguage();

  const cores = [
    { id: 1, name: 'Amarillo', image: require('../../assets/imagens/cores/amarelo.png') },
    { id: 2, name: 'Azul', image: require('../../assets/imagens/cores/azul.png') },
    { id: 3, name: 'Blanco', image: require('../../assets/imagens/cores/branco.png') },
    { id: 4, name: 'Gris', image: require('../../assets/imagens/cores/cinza.png') },
    { id: 5, name: 'Naranja', image: require('../../assets/imagens/cores/laranja.png') },
    { id: 6, name: 'Marrón', image: require('../../assets/imagens/cores/marrom.png') },
    { id: 7, name: 'Negro', image: require('../../assets/imagens/cores/preto.png') },
    { id: 8, name: 'Rosa', image: require('../../assets/imagens/cores/rosa.png') },
    { id: 9, name: 'Morado', image: require('../../assets/imagens/cores/roxo.png') },
    { id: 10, name: 'Verde', image: require('../../assets/imagens/cores/verde.png') },
    { id: 11, name: 'Rojo', image: require('../../assets/imagens/cores/vermelho.png') },
