...
const AnimaisPScreen = ({ navigation }) => {
  const { language, audios } = useLanguage();

  const animais = [
    { id: 1, name: 'Abelha', image: require('../../assets/imagens/animais/abelha.png') },
    { id: 2, name: 'Baleia', image: require('../../assets/imagens/animais/baleia.png') },
    { id: 3, name: 'Borboleta', image: require('../../assets/imagens/animais/borboleta.png') },
    { id: 4, name: 'Cachorro', image: require('../../assets/imagens/animais/cachorro.png') },
    { id: 5, name: 'Cavalo', image: require('../../assets/imagens/animais/cavalo.png') },
    { id: 6, name: 'Cobra', image: require('../../assets/imagens/animais/cobra.png') },
    { id: 7, name: 'Coelho', image: require('../../assets/imagens/animais/coelho.png') },
    { id: 8, name: 'Elefante', image: require('../../assets/imagens/animais/elefante.png') },
    { id: 9, name: 'Formiga', image: require('../../assets/imagens/animais/formiga.png') },
    { id: 10, name: 'Gato', image: require('../../assets/imagens/animais/gato.png') },
    { id: 11, name: 'Girafa', image: require('../../assets/imagens/animais/girafa.png') },
    { id: 12, name: 'Golfinho', image: require('../../assets/imagens/animais/golfinho.png') },
    { id: 13, name: 'Jacaré', image: require('../../assets/imagens/animais/jacare.png') },
    { id: 14, name: 'Leão', image: require('../../assets/imagens/animais/leao.png') },
    { id: 15, name: 'Macaco', image: require('../../assets/imagens/animais/macaco.png') },
    { id: 16, name: 'Ovelha', image: require('../../assets/imagens/animais/ovelha.png') },
    { id: 17, name: 'Passarinho', image: require('../../assets/imagens/animais/passaro.png') },
    { id: 18, name: 'Peixe', image: require('../../assets/imagens/animais/peixe.png') },
    { id: 19, name: 'Porco', image: require('../../assets/imagens/animais/porco.png') },
    { id: 20, name: 'Rato', image: require('../../assets/imagens/animais/rato.png') },
    { id: 21, name: 'Sapo', image: require('../../assets/imagens/animais/sapo.png') },
    { id: 22, name: 'Tartaruga', image: require('../../assets/imagens/animais/tartaruga.png') },
    { id: 23, name: 'Urso', image: require('../../assets/imagens/animais/urso.png') },
