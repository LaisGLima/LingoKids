...
const AlimentosEScreen = ({ navigation }) => {
  const { language, audios } = useLanguage();

  const alimentos = [
{ id: 1, name: 'Aguacate', image: require('../../assets/imagens/alimentos/abacate.png') },
{ id: 2, name: 'Piña', image: require('../../assets/imagens/alimentos/abacaxi.png') },
{ id: 3, name: 'Plátano', image: require('../../assets/imagens/alimentos/banana.png') },
{ id: 4, name: 'Papa', image: require('../../assets/imagens/alimentos/batata.png') },
{ id: 5, name: 'Brócoli', image: require('../../assets/imagens/alimentos/brocolis.png') },
{ id: 6, name: 'Zanahoria', image: require('../../assets/imagens/alimentos/cenoura.png') },
{ id: 7, name: 'Coco', image: require('../../assets/imagens/alimentos/coco.png') },
{ id: 8, name: 'Naranja', image: require('../../assets/imagens/alimentos/laranja.png') },
{ id: 9, name: 'Leche', image: require('../../assets/imagens/alimentos/leite.png') },
{ id: 10, name: 'Limón', image: require('../../assets/imagens/alimentos/limao.png') },
{ id: 11, name: 'Manzana', image: require('../../assets/imagens/alimentos/maca.png') },
{ id: 12, name: 'Sandía', image: require('../../assets/imagens/alimentos/melancia.png') },
{ id: 13, name: 'Frutilla', image: require('../../assets/imagens/alimentos/morango.png') },
{ id: 14, name: 'Pan', image: require('../../assets/imagens/alimentos/pao.png') },
{ id: 15, name: 'Queso', image: require('../../assets/imagens/alimentos/queijo.png') },
{ id: 16, name: 'Sándwich', image: require('../../assets/imagens/alimentos/sanduiche.png') },
{ id: 17, name: 'Helado', image: require('../../assets/imagens/alimentos/sorvete.png') },
...
export default AlimentosEScreen;
