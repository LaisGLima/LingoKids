...
const AlimentosIScreen = ({ navigation }) => {
  const { language, audios } = useLanguage();

  const alimentos = [
    { id: 1, name: 'Avocado', image: require('../../assets/imagens/alimentos/abacate.png') },
    { id: 2, name: 'Pineapple', image: require('../../assets/imagens/alimentos/abacaxi.png') },
    { id: 3, name: 'Banana', image: require('../../assets/imagens/alimentos/banana.png') },
    { id: 4, name: 'Potato', image: require('../../assets/imagens/alimentos/batata.png') },
    { id: 5, name: 'Broccoli', image: require('../../assets/imagens/alimentos/brocolis.png') },
    { id: 6, name: 'Carrot', image: require('../../assets/imagens/alimentos/cenoura.png') },
    { id: 7, name: 'Coconut', image: require('../../assets/imagens/alimentos/coco.png') },
    { id: 8, name: 'Orange', image: require('../../assets/imagens/alimentos/laranja.png') },
    { id: 9, name: 'Milk', image: require('../../assets/imagens/alimentos/leite.png') },
    { id: 10, name: 'Lemon', image: require('../../assets/imagens/alimentos/limao.png') },
    { id: 11, name: 'Apple', image: require('../../assets/imagens/alimentos/maca.png') },
    { id: 12, name: 'Watermelon', image: require('../../assets/imagens/alimentos/melancia.png') },
    { id: 13, name: 'Strawberry', image: require('../../assets/imagens/alimentos/morango.png') },
    { id: 14, name: 'Bread', image: require('../../assets/imagens/alimentos/pao.png') },
    { id: 15, name: 'Cheese', image: require('../../assets/imagens/alimentos/queijo.png') },
    { id: 16, name: 'Sandwich', image: require('../../assets/imagens/alimentos/sanduiche.png') },
    { id: 17, name: 'Ice Cream', image: require('../../assets/imagens/alimentos/sorvete.png') },
    { id: 18, name: 'Grape', image: require('../../assets/imagens/alimentos/uva.png') },
  ];
...
export default AlimentosIScreen;
