...
const NumerosIScreen = ({ navigation }) => {
  const { language, audios } = useLanguage();

  const numeros = [
    { id: 1, name: 'Zero', image: require('../../assets/imagens/numeros/0.png') },
    { id: 2, name: 'One', image: require('../../assets/imagens/numeros/1.png') },
    { id: 3, name: 'Two', image: require('../../assets/imagens/numeros/2.png') },
    { id: 4, name: 'Three', image: require('../../assets/imagens/numeros/3.png') },
    { id: 5, name: 'Four', image: require('../../assets/imagens/numeros/4.png') },
    { id: 6, name: 'Five', image: require('../../assets/imagens/numeros/5.png') },
    { id: 7, name: 'Six', image: require('../../assets/imagens/numeros/6.png') },
    { id: 8, name: 'Seven', image: require('../../assets/imagens/numeros/7.png') },
    { id: 9, name: 'Eight', image: require('../../assets/imagens/numeros/8.png') },
    { id: 10, name: 'Nine', image: require('../../assets/imagens/numeros/9.png') },
    { id: 11, name: 'Ten', image: require('../../assets/imagens/numeros/10.png') },
  ];
