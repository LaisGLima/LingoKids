...
const PartesDoCorpoEScreen = ({ navigation }) => {
  ...
  const partesDoCorpo = [
    ...
    { id: 3, name: 'Cabeza', image: require('../../assets/imagens/partes_do_corpo/cabeca.png') },
    { id: 4, name: 'Pelo', image: require('../../assets/imagens/partes_do_corpo/cabelo.png') },
    { id: 5, name: 'Mano', image: require('../../assets/imagens/partes_do_corpo/mao.png') },
    { id: 6, name: 'Niña', image: require('../../assets/imagens/partes_do_corpo/menina.png') },
    { id: 7, name: 'Niño', image: require('../../assets/imagens/partes_do_corpo/menino.png') },
    { id: 8, name: 'Nariz', image: require('../../assets/imagens/partes_do_corpo/nariz.png') },
    { id: 9, name: 'Ojos', image: require('../../assets/imagens/partes_do_corpo/olhos.png') },
    { id: 10, name: 'Oreja', image: require('../../assets/imagens/partes_do_corpo/orelha.png') },
    { id: 11, name: 'Pie', image: require('../../assets/imagens/partes_do_corpo/pe.png') },
    { id: 12, name: 'Pierna', image: require('../../assets/imagens/partes_do_corpo/perna.png') },
  ];
...
export default PartesDoCorpoEScreen;
