...
const NumerosPScreen = ({ navigation }) => {
  const { language, audios } = useLanguage();

  const numeros = [
    { id: 1, name: 'Zero', image: require('../../assets/imagens/numeros/0.png') },
    { id: 2, name: 'Um', image: require('../../assets/imagens/numeros/1.png') },
    { id: 3, name: 'Dois', image: require('../../assets/imagens/numeros/2.png') },
    { id: 4, name: 'Três', image: require('../../assets/imagens/numeros/3.png') },
    { id: 5, name: 'Quatro', image: require('../../assets/imagens/numeros/4.png') },
    { id: 6, name: 'Cinco', image: require('../../assets/imagens/numeros/5.png') },
    { id: 7, name: 'Seis', image: require('../../assets/imagens/numeros/6.png') },
    { id: 8, name: 'Sete', image: require('../../assets/imagens/numeros/7.png') },
    { id: 9, name: 'Oito', image: require('../../assets/imagens/numeros/8.png') },
    { id: 10, name: 'Nove', image: require('../../assets/imagens/numeros/9.png') },
    { id: 11, name: 'Dez', image: require('../../assets/imagens/numeros/10.png') },
  ];
