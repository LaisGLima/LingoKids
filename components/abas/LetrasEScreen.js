...
const LetrasEScreen = ({ navigation }) => {
  ...
  const letras = [
    ...
    { id: 3, name: 'Ce', image: require('../../assets/imagens/letras/C.png') },
    { id: 4, name: 'De', image: require('../../assets/imagens/letras/D.png') },
    { id: 5, name: 'E', image: require('../../assets/imagens/letras/E.png') },
    { id: 6, name: 'Efe', image: require('../../assets/imagens/letras/F.png') },
    { id: 7, name: 'Ge', image: require('../../assets/imagens/letras/G.png') },
    { id: 8, name: 'Hache', image: require('../../assets/imagens/letras/H.png') },
    { id: 9, name: 'i', image: require('../../assets/imagens/letras/I.png') },
    { id: 10, name: 'Jota', image: require('../../assets/imagens/letras/J.png') },
    { id: 11, name: 'Ka', image: require('../../assets/imagens/letras/K.png') },
    ...
    { id: 16, name: 'Pe', image: require('../../assets/imagens/letras/P.png') },
    { id: 17, name: 'Cu', image: require('../../assets/imagens/letras/Q.png') },
    { id: 18, name: 'Erre', image: require('../../assets/imagens/letras/R.png') },
    { id: 19, name: 'Esse', image: require('../../assets/imagens/letras/S.png') },
    { id: 20, name: 'Te', image: require('../../assets/imagens/letras/T.png') },
    { id: 21, name: 'U', image: require('../../assets/imagens/letras/U.png') },
    { id: 22, name: 'Uve', image: require('../../assets/imagens/letras/V.png') },
    { id: 23, name: 'Double Uve', image: require('../../assets/imagens/letras/W.png') },
    { id: 24, name: 'Équis', image: require('../../assets/imagens/letras/X.png') },
    { id: 25, name: 'Ye', image: require('../../assets/imagens/letras/Y.png') },
    { id: 26, name: 'Zeta', image: require('../../assets/imagens/letras/Z.png') },
  ];
