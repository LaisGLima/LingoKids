...
const CoresIScreen = ({ navigation }) => {
  const { language, audios } = useLanguage();

  const cores = [
    { id: 1, name: 'Yellow', image: require('../../assets/imagens/cores/amarelo.png') },
    { id: 2, name: 'Blue', image: require('../../assets/imagens/cores/azul.png') },
    { id: 3, name: 'White', image: require('../../assets/imagens/cores/branco.png') },
    { id: 4, name: 'Gray', image: require('../../assets/imagens/cores/cinza.png') },
    { id: 5, name: 'Orange', image: require('../../assets/imagens/cores/laranja.png') },
    { id: 6, name: 'Brown', image: require('../../assets/imagens/cores/marrom.png') },
    { id: 7, name: 'Black', image: require('../../assets/imagens/cores/preto.png') },
    { id: 8, name: 'Pink', image: require('../../assets/imagens/cores/rosa.png') },
    { id: 9, name: 'Purple', image: require('../../assets/imagens/cores/roxo.png') },
    { id: 10, name: 'Green', image: require('../../assets/imagens/cores/verde.png') },
    { id: 11, name: 'Red', image: require('../../assets/imagens/cores/vermelho.png') },
    { id: 12, name: 'Violet', image: require('../../assets/imagens/cores/violeta.png') },
  ];
